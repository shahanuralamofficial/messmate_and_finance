...
class AppStrings {
  static const Map<String, Map<String, String>> translations = {
    'en': {
      ...
      'app_lock': 'App Lock',
      'use_pin_lock': 'Use PIN Lock',
      'require_pin': 'Require PIN to open app',
      'biometric_lock': 'Biometric Lock',
      'fingerprint_face': 'Fingerprint or Face ID',
      'data_backup': 'Data Backup',
      'cloud_sync': 'Cloud Sync',
      'synced_firebase': 'Your data is synced with Firebase',
    ...
    'bn': {
      ...
      'app_lock': 'অ্যাপ লক',
      'use_pin_lock': 'পিন লক ব্যবহার করুন',
      'require_pin': 'অ্যাপ খুলতে পিন কোড লাগবে',
      'biometric_lock': 'বায়োমেট্রিক লক',
      'fingerprint_face': 'ফিংগারপ্রিন্ট বা ফেস আইডি',
      'data_backup': 'ডাটা ব্যাকআপ',
      'cloud_sync': 'ক্লাউড সিঙ্ক',
      'synced_firebase': 'আপনার ডাটা ফায়ারবেসে সুরক্ষিত',
      'set_new_pin': 'নতুন পিন সেট করুন',
      'security_setup': 'নিরাপত্তা সেটআপ',
      'cash': 'ক্যাশ',
      'bank': 'ব্যাংক',
